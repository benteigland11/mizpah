...
- A procedure improves by the worker who walked it: a step added, edited or reordered where it fell short. That is how the library learns; it reaches the store only when the work order lands green.
